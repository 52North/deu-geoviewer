...
export abstract class ViewerError {
  ...
  protected abstract createSummary(
    translation: InterpolatableTranslationObject
  ): string;

  protected abstract createDescription(
    translation: InterpolatableTranslationObject
  ): string;
  ...
  public createTicket(translation: InterpolatableTranslationObject): string {
    ...
    ticket +=
      '&errortype=' + this.createErrorType() + '; Type=' + this.resourceType;
    return ticket;
  }

  protected get resourceId(): string {
    return this.ckanResource && this.ckanResource.id
      ? this.ckanResource.id
      : 'n/a';
  }
